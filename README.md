...
我是一个 JavaScript 开发者。在 JavaScript 生态中，有许多包管理器，例如 `npm`、`yarn`、`pnpm`、`bun` 等等。
...
稍安勿躁！如果你想编写自己的命令别名，我将在后续章节为你阐述~

这里，我先向 JavaScript 开发者们介绍一下，如何使用 `co` 快速避免回忆不同包管理器命令的痛苦。

...
```sh
npm install --global co-win-x64@1.4.0
```

```sh
npm install --global co-linux-x64@1.4.0
```

```sh
npm install --global co-linux-arm64@1.4.0
```

```sh
npm install --global co-macos-x64@1.4.0
```

```sh
npm install --global co-macos-arm64@1.4.0
```
...
```sh
cd /tmp \
&& wget "https://cdn.npmmirror.com/packages/co-linux-x64/1.4.0/co-linux-x64-1.4.0.tgz" \
&& tar -xzf co-linux-x64-1.4.0.tgz \
